/**
 * In this example the "Average" value of the Mindsensors Line Sensor Array is
 * used to calculate a correction value for motor speeds to keep the robot on
 * the line.
 *
 * Edge cases are Average values of
 *
 * 10 -> Line Sensor is at RIGHT edge of the line
 * 80 -> Line Sensor is at LEFT edge of the line
 *
 * The ideal Average value is:
 *
 * 45 -> Line Sensor is in the MIDDLE of the line
 *
